...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center bg-stone-100 p-1 text-stone-500 dark:bg-[#0d0d0d] dark:text-stone-400 border',
      className
    )}
    {...props}
  />
